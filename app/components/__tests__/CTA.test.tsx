 ...
 *
 * vi.mock is hoisted before imports by Vitest's transform — it prevents the
 * module-level NEXT_PUBLIC_BFF_BASE_URL guard in waitlistApi.ts from throwing
 * at import time in the test environment (no env var set in CI or local test
 * runs unless explicitly configured). Individual tests use vi.spyOn to set
 * return values on the mocked module.
 *
